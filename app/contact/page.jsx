        ...
        <section style={{ padding: "80px 72px", maxWidth: 1100, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 60, alignItems: "start" }}>
            ...
            <div>
              ...
              <p style={{ color: "#60748b", fontSize: 15, lineHeight: 1.9, marginBottom: 36 }}>Our engineering team is ready to assist with your telecom infrastructure project. We typically respond to all inquiries within one business day.</p>
