...
export async function POST(request) {
  try {
    ...
    const { first, last, company, phone, email, subject, service, message } = body;
              ...
              <div style="margin-bottom: 32px;">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                  ...
                  <tr>
                    ...
                    <td style="padding: 10px 0; border-bottom: 1px solid #f0f5ff;">
                      <a href="tel:${phone}" style="font-size: 15px; color: #0055e9; text-decoration: none; font-weight: 500;">${phone || "—"}</a>
                    </td>
                  </tr>
                  <tr>
                    <td style="padding: 10px 0; border-bottom: 1px solid #f0f5ff;">
